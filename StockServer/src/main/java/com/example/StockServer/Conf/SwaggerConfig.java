package com.example.StockServer.Conf;
...
public class SwaggerConfig implements WebMvcConfigurer{
	...
	//서버 연결 :http://localhost:8000/swagger-ui/index.html#/
    ...
    */
    ...
    private static final String SERVICE_NAME = "Stock Server";
    private static final String API_VERSION = "V1";
    private static final String API_DESCRIPTION = "Stock Server API TEST";
